...
const ListarTarefa = () => {
  ...
  const filteredTarefas = tarefas.filter(tarefa => {
    return tarefa.tituloTarefa.toLowerCase().includes(search.toLowerCase()) || tarefa.descricaoTarefa.toLowerCase().includes(search.toLowerCase())
  })
    ...
    <Card>
      ...
      <CardHeader
        ...
        />
        <TextField label="Filtro de pesquisa" variant="standard" value={search} onChange={handleSearch}/>
      </div>    
        <CardContent>
